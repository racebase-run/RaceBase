...
<div class="mx-auto w-95 mt-4">
  <h2 class="mb-4"> Meet Schedule </h2>

  <div class="schedule mt-3 col-12 p-0">
    <div class="meet p-2 px-3" v-for="(meet, i) in team.schedule"> 
      ...
      <div class="d-flex align-items-center my-2">
        ...
        <div class="btn btn-outline-danger ml-auto px-2 py-1 btn-small" @click="removeFromSchedule(i)">Remove</div>
      </div>
    </div>
    <form @submit.prevent="addToSchedule" class="meet p-2 px-3">
      <div class="d-flex align-items-center">
        <fa icon="pencil-alt" class="mr-3"></fa>
        <input 
      ...
      <div class="mt-2 d-flex align-items-center"> 
        ...
        <input 
          ...
          required
        />
        <input type="submit" class="px-3 py-1 ml-auto form-control btn btn-primary btn-small" value="Add" />
      </div>
