...
<p><strong>Effective date: December 14, 2018</strong></p>

<p>RaceBase ("us", "we", or "our") operates the https://racebase.io website (hereinafter referred to as the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for RaceBase is based on the <a href="https://privacypolicies.com/blog/privacy-policy-template/">Privacy Policy Template from Privacy Policies</a>.</p>
...
<p>RaceBase uses the collected data for various purposes:</p>    
<ul>
...
<p>RaceBase will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure Of Data</h2>

<h3>Legal Requirements</h3>
<p>RaceBase may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of RaceBase</li>
...
<ul>
    <li>By email: support@breeze.software</li>
</ul>
...
export default {
  head () {
    return {
      title: "Privacy Policy - RaceBase", 
      meta: [{
        hid: "OpenGraph Image", 
        property: "og:image", 
        content: process.env.ROOT_URL + '/images/opengraph/privacy.png'
      }, {
        hid: "Description", 
        name: "description", 
        content: "Our community is our first priority. Please excuse our legalese"
      }]
    }
  }
}
